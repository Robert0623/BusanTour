...
public class RecruitCommentDto {
    ...
    public RecruitCommentDto() {}
    public RecruitCommentDto(Integer bno, Integer pcno, String comment, String commenter) {
        this.bno = bno;
        this.pcno = pcno;
    ...
    public boolean equals(Object o) {
        ...
        RecruitCommentDto that = (RecruitCommentDto) o;
