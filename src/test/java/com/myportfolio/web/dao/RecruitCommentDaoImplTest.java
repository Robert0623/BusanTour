...
public class RecruitCommentDaoImplTest {
    @Autowired
    ...
    public void delete() throws Exception {
        commentDao.deleteAll(1);
        RecruitCommentDto commentDto = new RecruitCommentDto(1, 0, "comment", "asdf");
    ...
    public void insert() throws Exception {
        ...
        commentDto = new RecruitCommentDto(1, 0, "comment", "asdf");
        assertTrue(commentDao.insert(commentDto)==1);
    ...
    public void selectAll() throws Exception {
        ...
        List<RecruitCommentDto> list = commentDao.selectAll(1);
